        ...
        <main>
            ...
            <HeroSequence>
              ...
              <HeroItem>
                <p className="hero__copy">
                  Registre o que está fazendo, reconstrua o que ficou pelo
                  caminho e entenda onde suas horas realmente foram usadas.
                </p>
              </HeroItem>
              <HeroItem>
          ...
          >
            <Reveal className="section-heading section-heading--center">
              ...
              <p>
                Experimente as ações abaixo. Esta demonstração é visual e não
                cria dados reais.
              </p>
            </Reveal>
          ...
          >
            <Reveal className="story-copy" direction="left">
              ...
              <h2 id="story-title">
                O tempo fragmentado volta a fazer sentido.
              </h2>
              <p>
                A Timeline conecta atividades, pausas e períodos reconstruídos
                em uma leitura cronológica — não em uma planilha de ponto.
              </p>
            </Reveal>
            <TimelineStory />
          </section>
          ...
          >
            <div className="landing-container estimate-layout">
              <Reveal className="section-heading" direction="left">
                ...
                <p>
                  Compare sem julgamento e use a diferença para compreender
                  melhor o trabalho.
                </p>
              </Reveal>
              <Reveal
                className="estimate-visual"
                direction="right"
                delay={0.08}
              >
                <div>
